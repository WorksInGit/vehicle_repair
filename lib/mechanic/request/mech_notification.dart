          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              itemBuilder: (context, index) {
                var notiData = notification[index].data() as Map<String, dynamic>;
                        ...
                        children: [
                            ...
                            child: Row(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(formattedTime,style: GoogleFonts.poppins(color: Colors.white),),
                                ),
                              ],
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [Text(formattedDate, style: GoogleFonts.poppins(
                                color: Colors.white,
                                      fontWeight: FontWeight.w300),)],
                            ),
                          )
